...
class MealItemViewController: UIViewController {
    ...
    var cancelButton: UIButton = {
        ...
        button.setImage(#imageLiteral(resourceName: "button-cancel-cross"), for: UIControl.State.normal)
    ...
    var shareButton: UIButton = {
        let button = UIButton(type: UIButton.ButtonType.custom)
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(#imageLiteral(resourceName: "button-share32"), for: UIControl.State.normal)
        button.addTarget(self, action: #selector(handleShare), for: UIControl.Event.touchUpInside)

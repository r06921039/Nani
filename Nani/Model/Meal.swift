...
struct Meal {
    ...
    init(name: String, review: String, type: String, image: String, time: String) {
        self.name = name;
        self.description = "";
        self.price = 0.00
        self.type = type
...
//                                  "Starters","Salads","Sweets", "Kids Menu"]
        let sections: [String] = ["Notes", "Info", "Reviews"]
...
//        return [m1, m2, m3, m4, m5]
        ...
        let m8 = Meal(name: "Home of the Blues Cheese Taco",
                      ...
                      price: 5.45)
        // Seafood Tacos
        let m9 = Meal(name: "Justin",
                      review: "These muffins were really tasty. I baked them just as the recipe said. I used 1 cup of shredded coconut in the batter. I then topped them off with some chopped pecans and more shredded coconut. Yummy!",
                      type: "Reviews",
                      image: "Justin",
                      time: "March 31, 2021")
        let m10 = Meal(name: "Jeff",
                       review: "GREAT!!! I changed it a little I used 1/2 cup of milk and 3/4 cup of applesauce instead of oil. Also I added a small mashed banana to the batter.",
                       type: "Reviews",
                       image: "Jeff",
                       time: "March 29, 2021")
        let m11 = Meal(name: "Justlam",
                       review: "Excellent base recipe for all kinds of muffins. It adapted really well so several substitutions: I used vanilla soy milk in place of milk, and honey in place of sugar.",
                       type: "Reviews",
                       image: "Justlam",
                       time: "March 10, 2021")
        let m12 = Meal(name: "Eric",
                       review: "This is the upmost delicious muffin recipe!! I had to bake for a bake sale. I made these and they sold very QUICK!",
                       type: "Reviews",
                       image: "Eric",
                       time: "March 1, 2021")
